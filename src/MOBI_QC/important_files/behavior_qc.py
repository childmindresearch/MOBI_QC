...
def behavior_qc(xdf_filename, stim_df) -> tuple[dict[str,int], bool]:
    ...
    audiofiles= [
        "../../NEW_AUDIO_44/Camp_Lose_A_Friend.wav",
        "../../NEW_AUDIO_44/Frog_Dissection_Disaster.wav",
        "../../NEW_AUDIO_44/I_Decided_To_Be_Myself_And_Won_A_Dance_Contest.wav",
        "../../NEW_AUDIO_44/I_Fully_Embarrassed_Myself_In_Zoom_Class1.wav",
        "../../NEW_AUDIO_44/Left_Home_Alone_in_a_Tornado.wav",
        "../../NEW_AUDIO_44/The_Birthday_Party_Prank_44.wav"
    ]
