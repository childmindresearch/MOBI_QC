...
For a demonstration of a line plot on polar axis, see
...
\NormalTok{theta }\OperatorTok{=} \DecValTok{4} \OperatorTok{*}\NormalTok{ np.pi }\OperatorTok{*}\NormalTok{ r}
...
\pandocbounded{\includegraphics[keepaspectratio]{hello_files/figure-pdf/fig-polar-output-1.pdf}}

}

\caption{\label{fig-polar}A line plot on polar axis}
